...
module.exports = async (req, res) => {
  ...
  try {
    const [orders, templates, coupons, customers, referrals, logs] = await Promise.all([
    ...
    return res.status(200).json({ success: true, orders, templates, coupons, customers, referrals, logs });
  } catch (error) {
